...
*/
    ...
    $tela = ' <div  class="collapse navbar-collapse" id="navbarResponsive">
                    ...
                    <ul class="nav navbar-nav mx-auto">
                      ...
                      <li class="nav-item" role="presentation">
                        <a  class="nav-link" onclick="xajax_Listar_Pessoas(); return false;" href="#"><img class="img" src="img/clientes.png"><br><font class="tit">Cadastro Pessoas</font></a>
                      </li class="nav-item" role="presentation">
                      <li class="nav-item">
...
//    $resp->alert('Aqui '); return $resp;
    ...
    $tela = '<form name="principal" method="post">
             <div class="ui form" id="pagina" style="display: block;">
...
function Valida($dados)
{
    ...
    if ($pessoa_id === 'eu') {
        $resp->alert(" Escolha uma pessoa para autenticar");
        return $resp;
    }
...
function Listar_Pessoas()
{
    ...
    if (is_array($resul)) {
        $tela  = '<div class="container familia-clean table-responsive">
                    <div> Pessoas Cadastradas : '.count($resul).'<button type="submit" class="btn btn-primary" onclick="xajax_Retorna_desiste();" style="float: right;">Fechar</button></div>
