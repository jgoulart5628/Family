...
if(!isset($GD_WORKAROUND))
  $GD_WORKAROUND="oldGD";          //set this to "oldGD" or "newGD" to switch off automatic GD version detection
...
// if (!isset($_GET['alb'])) { $album = 1; } else { $album = $_GET['alb']; }
if(!isset($basePath)) {
   $basePath="./";
} else {
